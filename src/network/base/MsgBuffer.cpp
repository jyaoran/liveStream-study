 ...
 * @Date: 2025-06-28 18:34:10
 * @LastEditors: jiangshan yaoranyaoran2015@outlook.com
 * @LastEditTime: 2025-07-21 17:53:00
 * @FilePath: /liveStream-study/src/network/base/MsgBuffer.cpp
 * @Description: 
 * @
...
void MsgBuffer::EnsureWritableBytes(size_t len)
{
    ...
    // 如果移动可读数据后有足够的空间
    if (head_ + WritableBytes() >= (len + kBufferOffset)) // 移动可读数据
    {
        // 将可读数据从当前位置复制到偏移位置
