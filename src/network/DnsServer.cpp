 ...
 * @Date: 2025-07-10 23:26:42
 * @LastEditors: jiangshan yaoranyaoran2015@outlook.com
 * @LastEditTime: 2025-07-10 23:57:47
 * @FilePath: /liveStream-study/src/network/DnsServer.cpp
 * @Description: 
 * @
...
namespace
{
    static InetAddress::ptr inet_address_null = std::make_shared<InetAddress>();
}
...
void DnsServer::GetHostInfo(const std::string &host, std::vector<InetAddress::ptr> &list)
{
    ...
    */
    ...
    {
        LOG(ERROR) << "getaddrinfo error: " << gai_strerror(ret);
        return;
    } 
