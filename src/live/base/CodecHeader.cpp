 ...
 * @Date: 2025-07-28 18:10:54
 * @LastEditors: jiangshan yaoranyaoran2015@outlook.com
 * @LastEditTime: 2025-07-28 18:22:07
 * @FilePath: /liveStream-study/src/live/base/CodecHeader.cpp
 * @Description:
 * @
...
void CodecHeader::SaveMeta(const PacketPtr &packet)
{
    ...
    LIVE_TRACE << "save meta, meta version:" << meta_version_
               ...
               << " elapse:" << TTime::getCurrentTimeInMS() - start_timestamp_ << "ms";
}
