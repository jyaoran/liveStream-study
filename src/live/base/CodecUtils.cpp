 ...
 * @Date: 2025-07-27 16:21:42
 * @LastEditors: jiangshan yaoranyaoran2015@outlook.com
 * @LastEditTime: 2025-07-27 16:22:47
 * @FilePath: /liveStream-study/src/live/base/CodecUtils.cpp
 * @Description: 
 * @
...
bool liveStream::live::CodecUtils::IsCodecHeader(const PacketPtr &packet)
{
        // 第一个字节是FLV
...
/// @param packet 
/// @return 
bool liveStream::live::CodecUtils::IsKeyFrame(const PacketPtr &packet)
{
    // 检查包的大小是否大于0
